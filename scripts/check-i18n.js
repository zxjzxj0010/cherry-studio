...
function syncTranslations() {
    if (!fs.existsSync(baseFilePath)) {
        console.error("\u4E3B\u6A21\u677F\u6587\u4EF6 ".concat(baseFileName, " \u4E0D\u5B58\u5728\uFF0C\u8BF7\u68C0\u67E5\u8DEF\u5F84\u6216\u6587\u4EF6\u540D\u3002"));
        return;
    }
    ...
    var files = fs.readdirSync(translationsDir).filter(function (file) { return file.endsWith('.json') && file !== baseFileName; });
    for (var _i = 0, files_1 = files; _i < files_1.length; _i++) {
        ...
        try {
            ...
            console.error("\u89E3\u6790 ".concat(file, " \u51FA\u9519\uFF0C\u8DF3\u8FC7\u6B64\u6587\u4EF6\u3002\u9519\u8BEF\u4FE1\u606F:"), error);
            continue;
        }
